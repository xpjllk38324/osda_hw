...
for c in range(10):
  ...
  for i, (train_index, test_index) in enumerate(kf.split(X,y)):
       ...
       pat_cls = fcalc.classifier.PatternBinaryClassifier(X_train.values, y_train.to_numpy(),categorical=np.arange(X_train.shape[1]),alpha=c/1000)
